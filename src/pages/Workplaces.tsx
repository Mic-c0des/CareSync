...
export function Workplaces() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <form onSubmit={handleAdd} className="mt-6 flex flex-col gap-3 rounded-2xl border border-ink/10 bg-white p-4 sm:flex-row">
        <input
      ...
      <ul className="mt-6 space-y-2">
        ...
        {workplaces.map((w) => (
          <li key={w.id} className="flex items-center justify-between rounded-2xl border border-ink/10 bg-white p-4">
            <div>
